  ...
  if (species !== undefined){
    for (let x in data.animals){
      if (species === data.animals[x].name){
        //Mirando popularity
        //return data.animals[x].popularity;
    ...
    for (let x in data.animals){
      //Mirando popularity
      //objetoAnimales[data.animals[x].name]=data.animals[x].popularity;
...
function animalPopularity(rating) {
  ...
  // your code here
  if (rating !== undefined){
    //Indico un array con los animales que coincidan en poblacion
    let listaAnimales = [];
    for (let x in data.animals){
